...
void LCD_SETUP(char *buffer) {
	...
	drawString8x12(10,10,"Temp Reader");
	setColor16(ST7735_16_CYAN);
	drawString(10,24,"By: Virgilio Castillo");
	setColor16(ST7735_16_WHITE);
	drawString8x12(10,40,"Temperature:");
	drawString8x12(10,70,"Calculating");
	//Information displayed
	drawString(10,90,"Using TI T124");
